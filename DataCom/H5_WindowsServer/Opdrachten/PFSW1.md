...
Na het controleren dat de servers (PFSV1 & PFSV2) correct opstarten kan je de installatie van PFSW1 afronden.

Controleer:

    - PFSV1 & PFSV2 starten beiden correct op
    - PFSV1 & PFSV2 zijn deel van het domein Poliforma.local
    - PFSV1 & PFSV2 hebben beiden de DNS Server Role en de AD Server role
